 ...
 * @author Luke Last
 */
public interface JeleniumSettingsBak {
   ...
   static int DEFAULT_TEST_RETRIES = 0;
   ...
   String KEY_LOG_HANDLERS = "log-handlers";
   ...
   List<LogHandlerFactory> getLogHandlers();
   ...
   /**
    * @return The default number of times to retry running a test if it fails. If not set the
    *         default value of {@value #DEFAULT_TEST_RETRIES} is used.
    */
   int getTestRetries();
